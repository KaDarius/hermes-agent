...
| [`codex-build-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex-build-agent) | Spawn Codex CLI as fleet build agent for code changes & CI. | `autonomous-ai-agents/codex-build-agent` |
